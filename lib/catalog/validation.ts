...
const productSchema = z.object({
  ...
  niche: z.enum(['Sports', 'Animal', 'Art & Music', 'Vintage', 'Lifestyle', 'Fantasy']),
  subNiche: z.enum(['Football', 'Cat', 'Dog', 'Rabbit Playboy', 'Lion', 'Tiger', 'Animal Graphic', 'Piano', 'Photography', 'Train', 'Statement / Novelty', 'Mythology Romance']),
