          ...
          <div className="flex flex-wrap items-center gap-5">
            ...
            <div className="flex-1">
              ...
              <p className="mt-1 text-sm font-semibold text-[var(--hiwaii-text-secondary)]">
                {lang === 'vi' ? 'Quay lại product studio để đổi artwork, kiểu áo hoặc chất liệu trước khi thanh toán.' : 'Swap artwork, shirt type, or material in the product studio before you check out.'}
              </p>
            </div>
            <Link
            ...
            >
              {lang === 'vi' ? 'Mở design studio' : 'Open design studio'}
            </Link>
          </div>
        </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="hiwaii-grid-bg hiwaii-orb-bg sticky top-24 h-fit rounded-2xl border border-[var(--hiwaii-border)] bg-[linear-gradient(165deg,#111f44_0%,#0a1734_64%,#081327_100%)] p-8">
              ...
              <button className="mb-4 inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-full bg-[var(--hiwaii-accent)] px-6 text-sm font-black uppercase tracking-[0.12em] text-[#071425] transition hover:brightness-105">
              ...
              <div className="mt-8 space-y-3 border-t border-[var(--hiwaii-border)] pt-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[var(--hiwaii-text-muted)]">{lang === 'vi' ? 'Dòng áo signature của Hiwaii' : 'Signature Hiwaii craftsmanship'}</p>
                  </div>
                </div>
              </div>
